    ...
    function renderBookings(bookings) {
        ...
        bookings.forEach(booking => {
            ...
            item.innerHTML = `
                ...
                <div class="actions">
                    <button class="edit-btn" onclick="editBooking('${booking.id}', '${booking.name}', '${booking.email}', '${booking.phone}', '${booking.busNumber}')">Edit</button>
    ...
    async function handleFormSubmit(event) {
        ...
        try {
            if (id) {
                ...
                // CrudCrud does not accept id in the body for PUT requests
